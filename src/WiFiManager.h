...
const char HTTP_HEAD[] PROGMEM            = "<!DOCTYPE html><html lang=\"pl\"><head><meta name=\"viewport\" charset=\"utf-8\" content=\"width=device-width, initial-scale=1, user-scalable=no\"/><title>{v}</title>";
...
class WiFiManager
{
  ...
  private:
    ...
    //const String  HTTP_HEAD = "<!DOCTYPE html><html lang=\"pl\"><head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"/><title>{v}</title>";
