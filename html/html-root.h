...
*/
const char WEB_ROOT_PAGE_ALL[] PROGMEM = R"rawliteral(<html lang='%{Language}%'><head><meta charset='utf-8'><meta name='viewport' content='width=device-width, initial-scale=1, shrink-to-fit=no'><title>Smogly - %{CurrentPageTitle}%</title>%{WEB_PAGE_CSS}%</head><body>
...
const char WEB_ROOT_PAGE_MEASUREMENTS_THP1[] PROGMEM = R"rawliteral(<h2>{TEXT_WEATHER}:</h2>
...
const char WEB_ROOT_PAGE_MEASUREMENTS_AIR[] PROGMEM = R"rawliteral(<h2>{TEXT_AIRPOLLUTION}:</h2>
