...
const char HTTP_HEAD[] PROGMEM            = "<!DOCTYPE html><html lang=\"pl\"><head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1, user-scalable=no\" charset=\"utf-8\"/><title>{v}</title>";
