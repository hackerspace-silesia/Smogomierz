...
const char WEB_ROOT_PAGE_MEASUREMENTS[] PROGMEM = R"rawliteral(<main role='main' class='container'><div class='jumbotron'>
...
// CONFIG PAGE - Start
	...
	const char WEB_CONFIG_PAGE_CONFIG[] PROGMEM = R"rawliteral(<br>
		<br><center>{ConfigDeviceButton}</a>
		<br>
		<br>{ConfigServicesButton}</a>
		<br><br></center>
		<hr><center><br>
